...
SET DESIRED_APOAPSIS TO 400000.
SET DESIRED_PERIAPSIS TO 700000.

PRINT "APOAPSIS SPEED: " + APOAPSIS_SPEED(REAL_APOAPSIS(), REAL_PERIAPSIS()).
PRINT "PERIAPSIS SPEED:" + PERIAPSIS_SPEED(REAL_APOAPSIS(), REAL_PERIAPSIS()).
PRINT "and".

PRINT "DESIRED APOAPSIS SPEED: " + APOAPSIS_SPEED(DESIRED_APOAPSIS + BODY:RADIUS, DESIRED_PERIAPSIS + BODY:RADIUS).
PRINT "DESIRED PERIAPSIS SPEED:" + PERIAPSIS_SPEED(DESIRED_APOAPSIS + BODY:RADIUS, DESIRED_PERIAPSIS + BODY:RADIUS).

ALTER_APOAPSIS_TO(DESIRED_APOAPSIS).
//ALTER_PERIAPSIS_TO(DESIRED_PERIAPSIS).
